...
model NavigationROGUE
  Vehicles.gliderROGUE gliderROGUE(rho_0(displayUnit = "kg/m3"), L_vehicle = 0.31, m_h = 8.22, m_mov = 2.0, m_w = 0.0, I_11 = 0.1, I_22 = 0.1, I_33 = 0.1, I_w_11 = 0.0, I_w_22 = 0.0, I_w_33 = 0.0, nabla_0 = 11.22*10^(-3), m_s_pos_sat = 0.1, m_s_neg_sat = -0.1, init_latitude = -0.557272337881529, init_longitude = 2.020011979653293, init_altitude = 0.0, v_0 = {0.000001, 0, 0.0000001}, VBD_tau = 2.5, K_D0 = 18.0, K_D = 109.0, K_beta = 0.0, K_L0 = 0.0, K_alpha = 306.0, K_M0 = 0.0, K_M = -36.5, r_0 = {0, 0, 0}, enableRhoVsDepth = false, VBD_max_volume = 2.0*10^(-3), VBD_min_volume = -2.0*10^(-3), r_mov = {0.0, 0.0, 0.04}, Z_wdot = 14.0, X_udot = 2.0, scaleDist = 0.001, enableAddedMassEffects = false, euler_0 = {0, 0, 2.356194490192345})  annotation(
