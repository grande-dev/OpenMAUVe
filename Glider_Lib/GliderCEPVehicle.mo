...
model GliderCEPVehicle
  ...
  Glider_Lib.Actuators.Elevator elevator(K_F_delta = 10.0, K_M_delta = -14.6, K_u_delta = 1.0)  annotation(
    Placement(visible = true, transformation(origin = {-62, -155}, extent = {{-48, -43}, {48, 43}}, rotation = 0)));
  Glider_Lib.Actuators.Elevator elevator1(K_F_delta = 10.0, K_M_delta = -14.6, K_u_delta = 1.0)  annotation(
    Placement(visible = true, transformation(origin = {-71, -230}, extent = {{-51, -42}, {51, 42}}, rotation = 0)));
equation
