...
model VerificationSeawing "This model test a single yo for the ROGUE glider as described in #72."
  ...
  Vehicles.gliderSeawing gliderSeawing(rho_0(displayUnit = "kg/m3"), r_0 = {0, 0, 50}, enableAddedMassEffects = true, v_0 = {0.0001, 0.0, 0.00005}, w_0 = {0.001, 0.0, 0.001}, r_mov = {0.4016, 0, 0.014})  annotation(
  ...
  GroundthruthVerification.SeawingGroundthruthVerification seawingGroundthruthVerification(initSegment1 = ramp1_start, initSegment2 = ramp2_start, checkTimeFinal = 5000.0)  annotation(
