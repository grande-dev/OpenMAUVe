...
model GenericGlider_mass_explicit "Main glider modelling layer"
  ...
  parameter Modelica.Units.SI.AngularVelocity w_0[3]={0.001,0,0.0001}
...
equation
  ...
  connect(addedMassForcesTorques.frame_b, hull.frame_a) annotation (
    Line(points={{-10.56,-59.46},{8,-59.46},{8,-30},{82,-30}}, color = {95, 95, 95}));
  ...
  connect(actuators.frame_a, hull.frame_a) annotation (
    Line(points={{-47.8,78.2},{-47.8,20},{8,20},{8,-30},{82,-30}},      color = {95, 95, 95}));
  ...
  connect(LinVelBody.v_rel[1], out_lin_vel_u) annotation (
    Line(points={{38,42.6667},{38,30},{70,30},{70,70},{110,70}},       color = {0, 0, 127}));
  connect(LinVelBody.v_rel[2], out_lin_vel_v) annotation (
    Line(points={{38,43},{38,30},{70,30},{70,44},{110,44}},            color = {0, 0, 127}));
  connect(LinVelBody.v_rel[3], out_lin_vel_w) annotation (
    Line(points={{38,43.3333},{38,30},{70,30},{70,20},{110,20}},       color = {0, 0, 127}));
  annotation (
