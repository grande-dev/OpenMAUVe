...
model GenericGlider_mass_explicit "Main glider modelling layer"
  ...
  Modelica.Blocks.Interfaces.RealInput in_pos_m_r(unit = "rad") annotation(Placement(visible = true, transformation(extent = {{-64, 78}, {-32, 110}}, rotation = 0), iconTransformation(origin = {-100, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput in_pos_m_s(unit = "rad") annotation(Placement(visible = true, transformation(extent = {{-64, 52}, {-32, 84}}, rotation = 0), iconTransformation(origin = {-103, 75}, extent = {{-9, -9}, {9, 9}}, rotation = 0)));
...
equation
  ...
  connect(in_pos_m_r, actuators.in_pos_m_r) annotation(
    Line(points = {{-48, 94}, {17, 94}}, color = {0, 0, 127}));
  connect(in_pos_m_s, actuators.in_pos_m_s) annotation(
    Line(points = {{-48, 68}, {-14.5, 68}, {-14.5, 88}, {17, 88}}, color = {0, 0, 127}));
  ...
  connect(actuators.frame_a, hull.frame_a) annotation(
    Line(points = {{30, 78}, {30, -30}, {82, -30}}, color = {95, 95, 95}));
