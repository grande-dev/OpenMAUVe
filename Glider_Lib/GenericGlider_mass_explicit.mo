...
model GenericGlider_mass_explicit "Main glider modelling layer"
  ...
  Modelica.Blocks.Interfaces.RealInput in_pos_m_r(unit = "rad") annotation (
    Placement(visible = true, transformation(extent = {{-142, 84}, {-110, 116}}, rotation = 0), iconTransformation(origin = {-100, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput in_pos_m_s(unit = "rad") annotation (
    Placement(visible = true, transformation(extent = {{-140, 52}, {-108, 84}}, rotation = 0), iconTransformation(origin = {-103, 75}, extent = {{-9, -9}, {9, 9}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput in_variable_ballast(unit = "kg") annotation (
    Placement(visible = true, transformation(origin = {-166, -52}, extent = {{-16, -16}, {16, 16}}, rotation = 0), iconTransformation(origin = {-98, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
