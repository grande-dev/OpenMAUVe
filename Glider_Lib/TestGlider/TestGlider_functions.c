  ...
  if((tmp1 > ((modelica_integer) 0)))
  {
    ...
    else
    {
      if((_p >= 9.999999999999999e+59))
      {
        {
          modelica_integer tmp3;
          real_array __omcQ_24tmpVar586;
          modelica_real __omcQ_24tmpVar585;
          modelica_integer tmp5;
          real_array __omcQ_24tmpVar584_loopVar;
          modelica_integer tmp6;
          modelica_real __omcQ_24tmpVar584;
          modelica_integer tmp7;
          __omcQ_24tmpVar584_loopVar = _v;
          tmp6 = 1;
          tmp7 = 0;
          tmp7 = modelica_integer_max(tmp7,size_of_dimension_base_array(__omcQ_24tmpVar584_loopVar, 1));
          tmp3 = 1;
          simple_alloc_1d_real_array(&__omcQ_24tmpVar586,tmp7);
          while(1) {
            tmp5 = 1;
            if(tmp6 <= size_of_dimension_base_array(__omcQ_24tmpVar584_loopVar, 1)) {
              __omcQ_24tmpVar584 = real_array_get1(__omcQ_24tmpVar584_loopVar, 1, tmp6++);
              tmp5--;
            }
            if (tmp5 == 0) {
              __omcQ_24tmpVar585 = fabs(__omcQ_24tmpVar584);
              real_array_get1(__omcQ_24tmpVar586, 1, tmp3++) = __omcQ_24tmpVar585;
            } else if (tmp5 == 1) {
              break;
            } else {
              MMC_THROW_INTERNAL();
      ...
      else
      {
        ...
        {
          {
            ...
            real_array __omcQ_24tmpVar589;
            modelica_real __omcQ_24tmpVar588;
            modelica_integer tmp11;
            real_array __omcQ_24tmpVar587_loopVar;
            modelica_integer tmp12;
            modelica_real __omcQ_24tmpVar587;
            modelica_integer tmp13;
            __omcQ_24tmpVar587_loopVar = _v;
            tmp12 = 1;
            tmp13 = 0;
            tmp13 = modelica_integer_max(tmp13,size_of_dimension_base_array(__omcQ_24tmpVar587_loopVar, 1));
            tmp9 = 1;
            simple_alloc_1d_real_array(&__omcQ_24tmpVar589,tmp13);
            while(1) {
              tmp11 = 1;
              if(tmp12 <= size_of_dimension_base_array(__omcQ_24tmpVar587_loopVar, 1)) {
                __omcQ_24tmpVar587 = real_array_get1(__omcQ_24tmpVar587_loopVar, 1, tmp12++);
                tmp11--;
              }
              if (tmp11 == 0) {
                __omcQ_24tmpVar588 = fabs(__omcQ_24tmpVar587);
                real_array_get1(__omcQ_24tmpVar589, 1, tmp9++) = __omcQ_24tmpVar588;
              } else if (tmp11 == 1) {
                break;
              } else {
                MMC_THROW_INTERNAL();
        ...
        else
        {
          ...
          {
            {
              modelica_real __omcQ_24tmpVar591;
              modelica_real tmp15;
              modelica_real tmp16;
              modelica_real tmp17;
              modelica_real tmp18;
              ...
              modelica_real tmp20;
              modelica_real tmp21;
              modelica_real __omcQ_24tmpVar590;
              ...
              __omcQ_24tmpVar591 = 0.0; /* defaultValue */
              while(1) {
                tmp22 = 1;
                ...
                if (tmp22 == 0) {
                  ...
                  {
                    throwStreamPrint(threadData, "%s:%d: Invalid root: (%g)^(%g)", __FILE__, __LINE__, tmp15, tmp16);
                  }__omcQ_24tmpVar590 = tmp17;
                  __omcQ_24tmpVar591 = __omcQ_24tmpVar591 + __omcQ_24tmpVar590;
                } else if (tmp22 == 1) {
                  break;
                } else {
                  MMC_THROW_INTERNAL();
