...
model GenericGlider_mass_explicit "Main glider modelling layer"
  ...
  Glider_Lib.Parts.Actuators actuators(I_r_x = I_11_r, I_r_y = I_22_r, I_r_z = I_33_r, m_HV_battery = m_HV_battery, m_battery_enclosure = m_battery_enclosure, m_r = m_r, r_HV_batt = r_HV_batt, r_b = r_b, r_batt_enclosure = r_batt_enclosure, r_p = r_p, r_r = r_r)
    ...
    Placement(visible = true, transformation(origin = {-58.3295, 79}, extent = {{-20.3382, -19}, {40.6763, 19}},      rotation = 0)));
  Glider_Lib.Parts.HydrodynamicForcesTorques hydrodynamicForcesTorques(
    final K_D=K_D,
    final K_D0=K_D0,
    final K_L0=K_L0,
    final K_M=K_M,
    ...
    final K_p=K_p,
    final K_q=K_q,
    final K_r=K_r) if enableHydrodynamic                                                                                                                                                                                          annotation (
    Placement(visible = true, transformation(origin = {-100, -6}, extent = {{-38, -22}, {38, 22}}, rotation = 0)));
  ...
  Glider_Lib.Parts.BuoyancyForce buoyancyForce(g = g, nabla_0 = nabla_0, rho = rho)
    if enableBuoyancy                                                    annotation (
    Placement(visible = true, transformation(origin = {-98, -55}, extent = {{-20, -13}, {20, 13}}, rotation = 0)));
  ...
  Glider_Lib.Parts.AddedMassForcesTorques addedMassForcesTorques(
    ...
    Placement(visible = true, transformation(origin={-92,-103},    extent={{-30, -21},
            {30, 21}},                                                                              rotation = 0)));
  ...
  replaceable parameter Glider_Lib.Records.AddedMassData_SeaGlider addedMassData_SeaGlider
