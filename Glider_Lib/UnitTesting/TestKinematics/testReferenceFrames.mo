within Glider_Lib.UnitTesting.TestKinematics;
...
model testReferenceFrames
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(m = 0)  annotation(
...
equation
  ...
  connect(referenceFrames.frame_to_Ob, body.frame_a) annotation(
    Line(points = {{-30, -22}, {-30, -50}, {72, -50}}, color = {95, 95, 95}));
