...
model TestROGUE "This model test a single yo for the ROGUE glider as described in #72."
  ...
  Control.manualInputs2Segments ref_m_s(init_offset = 0, ramp_segment1_duration = 10, ramp_segment1_height = 0.022, ramp_segment2_duration = 10, ramp_segment2_height = -0.022*2, ramp_segment2_st_time = 1000) annotation(
