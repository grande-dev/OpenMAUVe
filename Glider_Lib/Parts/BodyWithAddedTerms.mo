...
model BodyWithAddedTerms
  ...
  parameter SI.Inertia I_21(min=-C.inf) = 0.0 "(2,1) element of inertia tensor"
                                      annotation (Dialog(group=
          "Inertia tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_31(min=-C.inf) = 0.0 "(3,1) element of inertia tensor"
                                      annotation (Dialog(group=
          "Inertia tensor (resolved in center of mass, parallel to frame_a)"));
  ...
  parameter SI.Inertia I_f22(min=0, start=0.0) = 0.0 "(2,2) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f33(min=0, start=0.0) = 0.0 "(3,3) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f12(min=0, start=0.0) = 0.0 "(1,2) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f13(min=0, start=0.0) = 0.0 "(1,3) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f21(min=0, start=0.0) = 0.0 "(2,1) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f23(min=0, start=0.0) = 0.0 "(2,3) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
  parameter SI.Inertia I_f31(min=0, start=0.0) = 0.0 "(3,1) element of added inertia tensor"
    annotation (Dialog(group=
          "Inertia added tensor (resolved in center of mass, parallel to frame_a)"));
