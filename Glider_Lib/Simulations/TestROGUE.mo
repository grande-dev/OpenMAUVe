...
model TestROGUE
  Vehicles.gliderROGUE gliderROGUE(rho_0(displayUnit = "kg/m3"), r_g_hull = {0.0, 0.0, 0.04}, L_vehicle = 0.31, m_h = 8.22, m_mov = 2.0, m_w = 0.0, I_11 = 0.1, I_22 = 0.1, I_33 = 0.1, I_w_11 = 0.0, I_w_22 = 0.0, I_w_33 = 0.0, nabla_0 = 11.22*10^(-3), m_s_pos_sat = 0.1, m_s_neg_sat = -0.1, init_latitude = -0.557272337881529, init_longitude = 2.020011979653293, init_altitude = 0.0, v_0 = {0.0001, 0, 0.00001}, VBD_tau = 2.5, K_D0 = 18.0, K_D = 109.0, K_beta = 0.0, K_L0 = 0.0, K_alpha = 306.0, K_M0 = 0.0, K_M = -36.5, r_0 = {-1000, 0, -100}, enableRhoVsDensity = false, VBD_max_volume = 2.0*10^(-3), VBD_min_volume = -2.0*10^(-3))  annotation(
  ...
  Modelica.Blocks.Sources.Step in_VBD(height = 1.36, startTime = 100) annotation(
    Placement(transformation(origin = {-77, 29}, extent = {{-5, -5}, {5, 5}})));
  Modelica.Blocks.Sources.Step in_mov_mass(height = 0.0041) annotation(
...
equation
  ...
  connect(in_VBD.y, gliderROGUE.in_VBD_mass) annotation(
    Line(points = {{-72, 30}, {-42, 30}, {-42, 20}, {8, 20}}, color = {0, 0, 127}));
end TestROGUE;