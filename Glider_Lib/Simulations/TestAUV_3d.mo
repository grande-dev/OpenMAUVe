...
model TestAUV_3d "Test the AUV"
  ...
  Glider_Lib.Generic_AUV_3d generic_AUV_3d(enableAddedMass = false, v_0 = {0.3, 0.3, 0.0})  annotation(
    Placement(visible = true, transformation(origin = {86.5, 45}, extent = {{-71.5, -67}, {71.5, 67}}, rotation = 0)));
  Glider_Lib.Control.StateFeedbackControl_AH1_4thrusters stateFeedbackControl_AH1_4thrusters annotation(
    Placement(visible = true, transformation(origin = {-114.5, 49.5}, extent = {{-42.5, -42.5}, {42.5, 42.5}}, rotation = 0)));
  ...
  Glider_Lib.Faults.FaultInjection_4thrusters faultInjection_4thrusters annotation(
    Placement(visible = true, transformation(origin = {-174, 160}, extent = {{-31, -31}, {31, 31}}, rotation = 0)));
equation
