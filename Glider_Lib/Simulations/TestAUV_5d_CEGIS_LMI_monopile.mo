...
model TestAUV_5d_CEGIS_LMI_monopile "Test the AUV"
  ...
  Glider_Lib.Guidance.orbit_following_segments orbit_following_segments(gamma = 2.0, radius_hexagon = 10.0, x_hex = 30.0, y_hex = 30.0, u_ref_approach_phase = 0.3, v_ref_approach_phase = 0.0, min_perc_speed = 0.1)  annotation(
