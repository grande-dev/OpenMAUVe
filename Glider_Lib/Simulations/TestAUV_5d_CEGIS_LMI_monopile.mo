...
model TestAUV_5d_CEGIS_LMI_monopile "Test the AUV"
  ...
  Glider_Lib.Guidance.orbit_following_segments orbit_following_segments(gamma = 1.5, radius_hexagon = 10.0, x_hex = 30.0, y_hex = 30.0, u_ref_approach_phase = 0.5, v_ref_approach_phase = 0.0, min_perc_speed = 10, u_ref_inspection_phase = 0.5, v_ref_inspection_phase = 0.0, interrupt_sim_upon_returned_home = true, orbit_slide_sideways = false)  annotation(
