...
equation
  ...
  connect(velocityAngularBody_wrt_NED_in_NED[3], integrator_EA_3.u) annotation(
    Line(points = {{32, -64}, {-8, -64}, {-8, 32}, {78, 32}}, color = {0, 0, 127}));
  connect(integrator_EA_1.y, roll_pitch_yaw[1]) annotation(
    Line(points = {{102, 92}, {120, 92}, {120, 62}, {142, 62}}, color = {0, 0, 127}));
  connect(integrator_EA_2.y, roll_pitch_yaw[2]) annotation(
    Line(points = {{102, 62}, {142, 62}}, color = {0, 0, 127}));
  connect(integrator_EA_3.y, roll_pitch_yaw[3]) annotation(
    Line(points = {{100, 32}, {120, 32}, {120, 62}, {142, 62}}, color = {0, 0, 127}));
  annotation(
  ...
  Diagram(graphics = {Text(origin = {-64, 76}, extent = {{-16, 8}, {16, -8}}, textString = "ECI"), Text(origin = {-66, 38}, extent = {{-16, 8}, {16, -8}}, textString = "ECEF"), Text(origin = {-128, -8}, extent = {{-16, 8}, {16, -8}}, textString = "NED"), Text(origin = {-130, -56}, extent = {{-16, 8}, {16, -8}}, textString = "BODY"), Text(origin = {4, -112}, extent = {{-86, 12}, {86, -12}}, textString = "Rimani consistente con la nomenclatura! Suggerimento 
