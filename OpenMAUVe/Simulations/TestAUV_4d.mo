...
model TestAUV_4d "Test the AUV"
  ...
  OpenMAUVe.Generic_AUV_3d generic_AUV_3d(
    ...
    v_0={0.0,0.0,0.0}) annotation (Placement(visible=true, transformation(
        origin={82.5,60},
  ...
  OpenMAUVe.Control.StateFeedbackControl_AH1_4in_4out stateFeedbackControl_AH1_4in_4out(
      saturation_limit=37.5) annotation (Placement(visible=true, transformation(
        origin={-108.5,55.5},
        extent={{-70.5,-70.5},{70.5,70.5}},
        rotation=0)));
  OpenMAUVe.Faults.FaultInjection_4thrusters_distance_def faultInjection_4thrusters_distance_def
    annotation (Placement(visible=true, transformation(
        origin={-253,170},
        extent={{-24,-24},{24,24}},
        rotation=0)));
  OpenMAUVe.Guidance.LOS_guidance LOS_guidance_yaw_reference(gamma=5.0)
    annotation (Placement(visible=true, transformation(
        origin={-263.5,35.5},
