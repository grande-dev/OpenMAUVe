...
model TestAUV "Test the AUV"
  OpenMAUVe.Generic_AUV AUV_AH1(
    ...
    Z_w=6.106,
    Z_ww=5.0,
    alpha1(displayUnit="deg") = Modelica.Units.Conversions.from_deg(110.0),
    alpha2(displayUnit="deg") = Modelica.Units.Conversions.from_deg(70.0),
    alpha3(displayUnit="deg") = Modelica.Units.Conversions.from_deg(180.0),
    ...
    m_h=500.0,
    nabla_0=500/1000,
    rho(displayUnit="kg/m3") = 1000,
    v_0={0.00001,0.0000,0.0000}) annotation (Placement(visible=true,
        transformation(
        origin={64.5,47.5},
        extent={{-75.5,-71.5},{75.5,71.5}},
        rotation=0)));
  ...
  OpenMAUVe.Faults.FaultInjection faultInjection annotation (Placement(visible=
          true, transformation(
        origin={-145.5,122.5},
