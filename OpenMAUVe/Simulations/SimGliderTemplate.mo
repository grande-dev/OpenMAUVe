...
model SimGliderTemplate "The generic template to simulate the generic AUV"
  Vehicles.GenericAUV genericAUV(r_0 = {1, 1, 1}, r_NED = {5.43e3, -1.49e3, 2.97e3}, v_0 = {0.0001, 0, 0.00001}, euler_0 = {0, 0, 0}, w_0 = {0, 0, 0}, m_h = 54.28, r_g_hull = {0.0, 0.0, 0.05}, planet_radius(displayUnit = "Tm"), nabla_0 = 0.063687805, r_vbd_mass = {0.0, 0.0, 0.0}, rho_0(displayUnit = "kg/m3") = 1025, K_D0 = 7.19, K_D = 386.29, K_beta = -115.65, K_L0 = -0.36, K_alpha = 440.99, K_MR = -58.27, K_p_qua_stat = -19.83, K_M0 = 0.28, K_M = -65.84, K_q = -205.64, K_MY = 34.10, K_r = -389.30, L_vehicle = 1.99, I_11 = 0.60, I_22 = 15.27, I_33 = 15.32, enableRhoVsDensity = false, m_mov = 11.0, r_mov = {0.4016, 0.0, 0.014}, r_w = {0.0, 0.0, 0.0}, m_w = 0.0, I_mov_11 = 0.02, I_mov_22 = 10.16, I_mov_33 = 0.17, VBD_max_volume = 0.000487805, VBD_min_volume = -0.000487805, VBD_tau = 2.5, m_s_pos_sat = 0.05, m_s_neg_sat = -0.05, m_r_pos_angle = 0.7853981633974483, m_r_neg_angle = -0.7853981633974483, r_thruster1 = {-1.0, 0.0, 0.0}, thruster_max_force1 = 51.48, thruster_min_force1 = -40.21, thruster_deadband_neg1 = -0.3457, thruster_deadband_pos1 = 0.3457, thruster_tau1 = 0.025, D_p1 = 0.076, K_T1 = 0.00010783)  annotation(
