...
model TestAUV_5d_CEGIS_LMI "Test the AUV"
  OpenMAUVe.Generic_AUV_3d generic_AUV_3d(
    ...
    euler_0(each displayUnit="rad") = {114.592,0,0},
    rho(displayUnit="kg/m3"),
    v_0={2.0,2.0,0.0},
    w_0={0.0,0.0,2.0}) annotation (Placement(visible=true, transformation(
        origin={83.5,69},
  ...
  OpenMAUVe.Control.StateFeedbackControl_AH1_5in_4out_no_sat_CEGIS_LMI stateFeedbackControl_AH1_5in_4out_no_sat_CEGIS_LMI(
      saturation_limit=38.0) annotation (Placement(visible=true, transformation(
        origin={-124.5,51.5},
        extent={{-80.5,-80.5},{80.5,80.5}},
        rotation=0)));
  ...
  OpenMAUVe.Faults.FaultInjection_4thrusters faultInjection_4thrusters(
      efficiency_after_fault=10) annotation (Placement(visible=true,
        transformation(
        origin={-242.5,184.5},
