...
model TestAUV_5d_CEGIS_LMI_monopile "Test the AUV"
  OpenMAUVe.Vehicles.Generic_AUV_3d_deprecated generic_AUV_3d(
    Y_v = 11.203,
    Y_vv = 10.114,
    ...
    v_0 = {0.0, 0.0, 0.0},
    w_0 = {0.0, 0.0, 0.0}) annotation(
    Placement(transformation(origin = {82.5, 69}, extent = {{-71.5, -67}, {71.5, 67}})));
  OpenMAUVe.Faults.FaultInjection_4thrusters faultInjection_4thrusters(
    ...
    time_fault_u3 = 900,
    time_fault_u4 = 1300,
    fault_duration = 60) annotation(
    Placement(transformation(origin = {-243.5, 184.5}, extent = {{-27.5, -27.5}, {27.5, 27.5}})));
  ...
  OpenMAUVe.Control.StateFeedbackControl_AH1_5in_4out_no_sat_CEGIS_LMI stateFeedbackControl_AH1_5in_4out_no_sat_CEGIS_LMI(saturation_limit = 38.0) annotation(
    Placement(transformation(origin = {-132.5, 51.5}, extent = {{-80.5, -80.5}, {80.5, 80.5}})));
  ...
  OpenMAUVe.Guidance.orbit_following_segments orbit_following_segments(
    ...
    orbit_slide_sideways = true) annotation(
