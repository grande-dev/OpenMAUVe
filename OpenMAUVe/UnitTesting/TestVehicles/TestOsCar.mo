...
model TestOsCar "This model test a single yo for the ROGUE glider as described in #72."
  ...
  Vehicles.OsCar osCar(adimensionalHydroParamUsed = false, rho_0(displayUnit = "kg/m3"), r_0 = {0, 0, 0.75}, show_frames_vehicles = true, nabla_0 = 0.002877, r_fin_caudal = {-0.25, 0.0, 0.0}, A_fin_open_caudal = 0.011, A_fin_closed_caudal = 0.004, length_fin_caudal = 0.145, fin_freq_saturation_pos_caudal = 10.0, scaleDist = 10^(-6), show_shapes = true, enableAddedMassEffects = true) annotation(
