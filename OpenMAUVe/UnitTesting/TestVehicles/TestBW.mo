...
model TestBW "This model tests a BW glider."
  ...
  Vehicles.gliderBW gliderBW(rho_0(displayUnit = "kg/m3") = 1000, r_g_hull = {0, 0, 0}, r_vbd_mass = {0, 0, 0}, r_mov = {0, 0, 0.04}, m_h = 8.22, I_11 = 0.1, I_22 = 0.1, I_33 = 0.1, I_31 = 0.0, nabla_0 = 11.22*10^(-3), m_mov = 2.0, I_mov_11 = 0, I_mov_22 = 0, I_mov_33 = 0, X_udot = 2.0, Y_vdot = 0, Z_wdot = 14.0, M_qdot = 0, N_rdot = 0, Y_rdot = 0, Z_qdot = 0, M_wdot = 0, N_vdot = 0, K_D0 = 18.0, K_D = 109.0, K_beta = 0, K_L0 = 0, K_alpha = 306.0, K_MR = 0, K_p_qua_stat = 0, K_M0 = 0, K_M = -36.5, K_q = 0, K_MY = 0, K_r = 0, r_0 = {0, 0, 50}, kappa_h = 0.0, VBD_max = 10.0, VBD_min = -10.0)  annotation(
