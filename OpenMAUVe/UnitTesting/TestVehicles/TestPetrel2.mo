...
model TestPetrel2 "This model tests a Seawing glider as described in #99."
  ...
  Modelica.Blocks.Sources.Ramp VBD_input(height = -2.1, duration = 10.0, startTime = 60)  annotation(
  ...
  Vehicles.gliderPetrel2 gliderPetrel2(r_0 = {0, 0, 2}, scaleDist = 10^(-6), show_frames_vehicles = true)  annotation(
