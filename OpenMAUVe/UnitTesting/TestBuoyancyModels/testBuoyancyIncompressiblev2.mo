...
model testBuoyancyIncompressiblev2 "This model tests the dynamics of the buyancy force of an incompressible body modelled as BuoyancyForceIncompressibleHullv2. The buoyancy exactly compensates for the mass. The test is passed if the body does not move."
  ...
  Parts.RigidBody rigidBody(r_CM = r_g_hull, m = m_h, I_11 = I_11, I_22 = I_22, I_33 = I_33)  annotation (
    Placement(transformation(origin = {96, -117}, extent = {{-22, -22}, {22, 22}})));
  ...
  Hydrostatics.BuoyancyForceIncompressibleHullv2 buoyancyForceIncompressibleHullv2(mass_vehicle = m_h)  annotation(
    Placement(transformation(origin = {-129, -79.5}, extent = {{-23, -19.5}, {23, 19.5}})));
equation
  ...
  connect(referenceFrames.frame_to_Ob, rigidBody.frame_a) annotation(
    Line(points = {{-85.5, 9.54}, {-73.5, 9.54}, {-73.5, -117}, {74, -117}}, color = {95, 95, 95}));
  connect(relativeSensorNED.frame_b, rigidBody.frame_a) annotation(
    Line(points = {{14, 28}, {24, 28}, {24, 10}, {-20, 10}, {-20, -117}, {74, -117}}, color = {95, 95, 95}));
  ...
  connect(relativeSensorECI.frame_b, rigidBody.frame_a) annotation(
    Line(points = {{24, 72}, {48, 72}, {48, -8}, {-12, -8}, {-12, -117}, {74, -117}}, color = {95, 95, 95}));
  ...
  connect(positionAttitudeAndDer.frame_Ob, rigidBody.frame_a) annotation(
    Line(points = {{102, -4}, {-0.296, -4}, {-0.296, -117}, {74, -117}}, color = {95, 95, 95}));
  ...
  connect(positionAttitudeAndDer.frame_Om, rigidBody.frame_a) annotation(
    Line(points = {{102, -29}, {19, -29}, {19, -117}, {74, -117}}, color = {95, 95, 95}));
  ...
  connect(buoyancyForceIncompressibleHullv2.frame_b, rigidBody.frame_a) annotation(
    Line(points = {{-106, -79}, {-41, -79}, {-41, -117}, {74, -117}}, color = {95, 95, 95}));
  connect(buoyancyForceIncompressibleHullv2.signalBus, positionAttitudeAndDer.signalBus) annotation(
    Line(points = {{-129, -99}, {-126, -99}, {-126, -158}, {167, -158}, {167, -16}}, color = {255, 204, 51}, thickness = 0.5));
...
end testBuoyancyIncompressiblev2;