...
model VerificationOsCar "This model aims at manoueuvring OsCar."
  ...
  Vehicles.OsCar osCar( rho_0(displayUnit = "kg/m3"), r_0 = {0, 0, 100.0}, show_frames_vehicles = true, nabla_0 = 0.002877, r_fin_caudal = {-0.25, 0.0, 0.0}, fin_freq_saturation_pos_caudal = 1000.0, show_shapes = true, fin_amplitude_saturation_pos_caudal(displayUnit = "rad"), fin_amplitude_saturation_neg_caudal(displayUnit = "rad"), M_qdot = 0.002043139, X_u = 31.0, enableAddedMassEffects = true, r_g_hull = {0.0, 0.0, 0.1}, enable_propulsion = false)  annotation(
