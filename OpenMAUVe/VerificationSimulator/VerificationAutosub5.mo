...
model VerificationAutosub5 "This model aims at manoueuvring Autosub5."
  ...
  Vehicles.Autosub5 autosub5( r_0 = {0, 0, 2}, show_frames_vehicles = true, Y_r = 0, Z_q = 0, M_w = 0, N_v = 0, show_forces_and_moments = false, nabla_0 = 2.796692607, scaleDist = 10^(-6), enable_control_surfaces = false, enable_propulsion = false)  annotation(
  ...
  Modelica.Blocks.Sources.RealExpression referenceStarbThrusterRPM1(y = if time > 50 and time < 150 then 25.0 else -50.0) annotation(
...
equation
  ...
  connect(referenceStarbThrusterRPM1.y, autosub5.in_fin_port_top) annotation(
    Line(points = {{-68, -40}, {-30, -40}, {-30, -22}, {4, -22}}, color = {0, 0, 127}));
  annotation(
