...
model FlowFrameQuantitiesControlSurface "A model to inject the quantities relative to the flow frame into the signal bus."
...
end FlowFrameQuantitiesControlSurface;